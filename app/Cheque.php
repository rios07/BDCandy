...
class Cheque extends Model
{
    ...
    protected $primaryKey = 'med_pag_che_codigo';
   ...
   protected $fillable=['med_pag_che_numero','med_pag_che_cuenta','med_pag_che_banco', 'fk_cliente_juridico', 'fk_cliente_natural'  ];
}
